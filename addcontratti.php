...
if(isset($_POST['step'])){
	switch ($_POST['step']) {
		...
		case 3:
			...
			if ($rsOfferte['OffertaPersonalizzata'] == '0') // Offerta non personalizzata
			{
		...
		else // offerta personalizzata 
		{
			...
			<br />";
				...
				echo "<form action=\"addcontratti.php\" method=\"post\">
					...
					<br />
					<fieldset id=\"inputs\" style=\"border:1px solid #128F9A\">
					<legend>Informazioni Contratto Personalizzato</legend>
						<label>Informazioni Aggiuntive</label>
						<textarea id=\"ContrattoNote\" name=\"ContrattoNote\" type=\"text\" placeholder=\"Note\">
						</textarea>
					</fieldset>
					<input id=\"IdCliente\" name=\"IdCliente\" type=\"hidden\" value=\"".$_POST['IdCliente']."\" >
						<input id=\"ClienteTipologia\" name=\"ClienteTipologia\" type=\"hidden\" value=\"".$_POST['ClienteTipologia']."\" >
						<input id=\"OffertaId\" name=\"OffertaId\" type=\"hidden\" value=\"".$rsOfferte['OffertaId']."\" >
						<input id=\"step\" name=\"step\" type=\"hidden\" value=\"42\" >
					</fieldset>
					<fieldset id=\"actions\">
						<input type=\"submit\" id=\"submit\" value=\"avanti\">
					</fieldset>
			...
			break;
		case 42:
			echo "<h3>STEP 4 - Riepilogo Contratto Personalizzato</h3>";
			// Prelevo il Cliente
			...
			<form action=\"addcontratti.php\" method=\"POST\" name=\"form\">
				...
				<input id=\"ContrattoPunti\" name=\"ContrattoPunti\" type=\"hidden\" value=\"".$rsOfferta['OffertaPunti']."\" >
				...
				<input id=\"step\" name=\"step\" type=\"hidden\" value=\"52\" >
		...
		case 52:
			...
			$result = mysql_query('SELECT MAX( ContrattoId ) as ContrattoId FROM Contratti');
